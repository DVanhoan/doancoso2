        ...
        <div className='w-full z-10'>
          ...
          <div className='w-full flex items-center justify-around bg-white px-2 md:px-5 py-2.5 md:py-6 shadow-2xl rounded-full'>
            ...
            <div>
              <CustomButton
                ...
                title='Search'
                containerStyles={
                  "text-white py-2 md:py3 px-3 md:px-10 focus:outline-none bg-[#0261a6] rounded-full md:rounded-md text-sm md:text-base"
                }
              />
            </div>
          </div>
          ...
          {type && (
            <div className='w-full lg:1/2 flex flex-wrap gap-3 md:gap-6 py-10 md:py-14'>
              <p className='text-white font-bold text-xl'>Popular Searches:</p>
              {popularSearch.map((search, index) => (
                <span
                  key={index}
                  className='bg-[#1d4fd826] text-white py-1 px-2 rounded-full text-sm md:text-base'
                >
                  {search}
                </span>
              ))}
